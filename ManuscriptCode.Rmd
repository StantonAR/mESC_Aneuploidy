...
```
##### Load necessary data
Set working directory to the file containing the count matrix, feature list, and barcode lists. Set working directory separately for early and aged data.
...
features_tsv <- read_delim("./features.tsv.gz",
